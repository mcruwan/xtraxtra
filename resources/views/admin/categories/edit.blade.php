    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                <form id="category-form" action="{{ route('admin.categories.update', $category) }}" method="POST" class="space-y-6 p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 bg-red-50 @enderror">{{ old('description', $category->description) }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="{{ old('wordpress_category_id', $category->wordpress_category_id) }}"
                ...
                <!-- Form Actions -->
                <div class="bg-gray-50 border-t border-gray-200 px-6 py-4 flex items-center justify-between gap-3">
            ...
            <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-800 mt-1">This category has <strong>{{ $category->newsSubmissions()->count() }}</strong> associated article(s). Changes to the name will not affect existing associations.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            nameInput.addEventListener('blur', function() {
                if (slugInput.value === originalSlug && nameInput.value !== '') {
