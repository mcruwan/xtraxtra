                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-3">
                                            ...
                                            @if($university->status === 'active')
                                                <form method="POST" action="{{ route('admin.impersonate', $university) }}" class="inline">
                                                    @csrf
                                                    <button type="submit" class="text-purple-600 hover:text-purple-900 transition-colors" title="Login as University">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
