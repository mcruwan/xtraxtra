                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                @if($adminUser->id !== auth()->id())
                                                    <form action="{{ route('admin.admin-users.destroy', $adminUser) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this admin user? This action cannot be undone.');">
                                                        @csrf
                                                        @method('DELETE')
