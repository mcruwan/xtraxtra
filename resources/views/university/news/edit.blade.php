<x-university-layout>
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Page Header -->
            <x-page-header title="Edit News Submission" description="Update your news submission details">
                <x-slot name="actions">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="content" id="content" rows="15"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 @error('content') border-red-300 @enderror"
