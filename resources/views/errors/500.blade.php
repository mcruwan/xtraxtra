<x-error-layout>
    <div class="max-w-2xl w-full text-center">
        ...
        <div class="mb-8">
            <div class="mx-auto flex items-center justify-center w-32 h-32 bg-orange-100 rounded-full mb-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-6">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button onclick="window.location.reload()" class="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-gray-200 transition-colors">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
